...
public:
  ...
  void setupUi(QDialog *NotificationDialog) {
    ...
    QObject::connect(push_back, SIGNAL(clicked()), NotificationDialog,
                     SLOT(close()));
  ...
  void retranslateUi(QDialog *NotificationDialog) {
    NotificationDialog->setWindowTitle(
        QApplication::translate("NotificationDialog", "DistImage", nullptr));
    push_refresh->setText(
        QApplication::translate("NotificationDialog", "Refresh", nullptr));
    push_back->setText(
        QApplication::translate("NotificationDialog", "Back", nullptr));
    push_approve->setText(
        QApplication::translate("NotificationDialog", "Approve", nullptr));
    line_views->setText(QString());
    push_disapprove->setText(
        QApplication::translate("NotificationDialog", "Disapprove", nullptr));
    lbl_result->setText(
        QApplication::translate("NotificationDialog", "Approved", nullptr));
  } // retranslateUi
};
