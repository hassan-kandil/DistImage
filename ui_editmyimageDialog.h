...
public:
    ...
    void setupUi(QDialog *editmyimageDialog)
    {
        ...
        push_request = new QPushButton(editmyimageDialog);
    ...
    void retranslateUi(QDialog *editmyimageDialog)
    {
        ...
        lbl_user->setText(QApplication::translate("editmyimageDialog", "Shared Images", nullptr));
        push_back->setText(QApplication::translate("editmyimageDialog", "Back", nullptr));
        push_request->setText(QApplication::translate("editmyimageDialog", "Request", nullptr));
