...
public:
  ...
  void setupUi(QDialog *SecondDialog) {
    ...
    horizontalSpacer =
        new QSpacerItem(154, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    horizontalSpacer_5 =
        new QSpacerItem(58, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    lbl_upload_successful->setObjectName(
        QStringLiteral("lbl_upload_successful"));
  ...
  void retranslateUi(QDialog *SecondDialog) {
    SecondDialog->setWindowTitle(
        QApplication::translate("SecondDialog", "DistImage", nullptr));
    push_users->setText(
        QApplication::translate("SecondDialog", "All Users", nullptr));
    push_shared->setText(
        QApplication::translate("SecondDialog", "Shared Images", nullptr));
    push_images->setText(
        QApplication::translate("SecondDialog", "My Images", nullptr));
    push_notifications->setText(
        QApplication::translate("SecondDialog", "Notifications", nullptr));
    push_upload->setText(
        QApplication::translate("SecondDialog", "Upload", nullptr));
    push_logout->setText(
        QApplication::translate("SecondDialog", "Logout", nullptr));
    lbl_upload_successful->setText(QApplication::translate(
        "SecondDialog", "Uploaded Successfully!", nullptr));
  } // retranslateUi
};
