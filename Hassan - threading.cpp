...
static void sendImage(Client * client,string privatePath, string name,int port){
...
int mainClient(string hostname, int port, string privatePath,bool grantRequest){
